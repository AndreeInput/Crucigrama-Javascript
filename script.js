...
const NumbersUserBlock = () =>{
    ...
    if (ArrayNumero.length !== ArrayCorrectos.length) {
        ...
        enviar.addEventListener('click',()=>{
            guardarDatosUsuario(ObtenerNombreUsuario(),contador);
            refreshN()
            guardarTiempo()          
            bandera = false;  
...
//Localstorage------------------------------------------------------------
// Función para guardar los datos de un usuario en localStorage
function guardarDatosUsuario(nombre, tiempo) {
// Obtener los datos existentes de localStorage
  let tablaPosiciones = JSON.parse(localStorage.getItem('tablaPosiciones')) || [];
// Agregar el nuevo usuario y tiempo a la tabla de posiciones
  tablaPosiciones.push({ nombre, tiempo });
// Ordenar la tabla de posiciones por tiempo de forma ascendente
  tablaPosiciones.sort((a, b) => a.tiempo - b.tiempo);
// Guardar la tabla de posiciones actualizada en localStorage
...
// Obtener los datos de la tabla de posiciones almacenados en localStorage
  const tablaPosiciones = JSON.parse(localStorage.getItem('tablaPosiciones'));
// Verificar si hay datos en la tabla de posiciones
  ...
  olElement.appendChild(liElement);
    ...
    console.log('Aún no hay datos en la tabla de posiciones.');
    }
}
//Localstorage termina el bloque------------------------------------------------------------
